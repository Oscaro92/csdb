            ...
            <Header></Header>
                ...
                <Container className="py-5">
                    <Row className="text-start fs-5">
                        ...
                        <Image src={image1} className="py-3 rounded" fluid/>
                    ...
                    <Row className="py-5 text-start fs-5">
                        ...
                        <Col className="d-flex justify-content-center" sm={20} md={6}>
                            <Image className="rounded" src={image2} fluid/>
                        </Col>
                    </Row>
                    <Row className="py-5 text-start fs-5">
                        <Col className="d-flex justify-content-center" sm={20} md={6}>
                    ...
                    <Row className="py-5 text-start fs-5">
                        ...
                        <Col className="d-flex justify-content-center py-3 py-sm0" sm={20} md={4}>
                            <Image className="rounded" src={bimba} fluid/>
                        </Col>
                    ...
                    <Row className="py-5 text-start fs-5">
                        ...
                        <Col className="d-flex justify-content-center py-3 py-sm0" sm={20} md={4}>
                            <Image className="rounded" src={pastinha} fluid/>
                        </Col>
                        <Col sm={20} md={8}>
